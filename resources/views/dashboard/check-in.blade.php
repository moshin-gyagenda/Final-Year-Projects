    ...
    <table class="table border-0 star-visitor table-hover table-center mb-0 datatable table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $visitor->phone }}</td>
                <form action="{{ route('visitor.check-in') }}" method="POST" class="mr-2">
                    @csrf
                <td>
                    <div class="d-flex align-items-center">
                            ...
                            <div class="form-group mb-0">
                                <input type="datetime-local" name="checkin_datetime" class="form-control" required>
                            </div>
                            <button type="submit" class="btn btn-sm bg-info" style="margin-left: 5px;">Check-In</button>
