    ...
    <table class="table border-0 star-visitor table-hover table-center mb-0 datatable table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <form action="{{ route('visitor.check-out') }}" method="POST" class="mr-2">
                    @csrf
                    <td>
                        <div class="d-flex align-items-center">
                            <input type="hidden" name="visitor_id" value="{{ $visitor->id }}">
                            <div class="form-group mb-0">
                                <input type="datetime-local" name="checkout_datetime" class="form-control" required>
                            </div>
                            <button type="submit" class="btn btn-sm bg-danger" style="margin-left: 5px;">Check-Out</button>
                        </div>
                    </td>
                </form>
