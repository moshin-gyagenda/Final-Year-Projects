...
<a href="{{route('add-student')}}" class="btn btn-primary"><i class="fas fa-plus"></i></a>
</div>
</div>
</div>
...
<a href="student-details.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="{{asset('assets/img/profiles/avarta.jpg')}}" alt="User Image"></a>
...
<td class="text-end">
<div class="actions ">
<form action="{{ route('student-details', $student->id) }}" method="GET">
    @csrf
